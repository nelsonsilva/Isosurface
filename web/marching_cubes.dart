 ...
 */
class MarchingCubes {
  static final edgeTable = new Uint32Array.fromList([
      ...
      for(x[1]=0; x[1]<dims[1]-1; ++x[1], ++n) {
        for(x[0]=0; x[0]<dims[0]-1; ++x[0], ++n) {
          ...
          for(var i=0; i<f.length; i += 3) {
            faces.add([edges[f[i]], edges[f[i+1]], edges[f[i+2]]]);
          }
        }
      }
    }
    return new Result( vertices: vertices, faces: faces );
  }
}

class Result {
  var vertices, faces;
  Result({this.vertices, this.faces});
}
